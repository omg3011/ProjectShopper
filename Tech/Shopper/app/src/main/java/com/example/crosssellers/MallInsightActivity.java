...
public class MallInsightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mall_insight);
        ...
        // Init View
        graph = (GraphView) findViewById(R.id.mall_GV);
...
*/
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series s, DataPointInterface dataPoint) {
                Toast.makeText(MallInsightActivity.this, "(" + dataPoint.getX() + "," + dataPoint.getY() + ")", Toast.LENGTH_SHORT).show();
            }
        });
